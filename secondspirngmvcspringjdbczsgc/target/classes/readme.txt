...
删
http://localhost:8080/secondspirngmvcspringjdbczsgc/dodeleteevents?event_id=22

改
http://localhost:8080/secondspirngmvcspringjdbczsgc/updateevents?event_id=21

查
http://localhost:8080/secondspirngmvcspringjdbczsgc/searchevents

列表
http://localhost:8080/secondspirngmvcspringjdbczsgc/geteventslist
